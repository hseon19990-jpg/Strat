...
**How to apply:** Never print or persist the token. Fetch first, inspect divergence, merge remote changes without force-pushing, then push the merged branch using a temporary askpass helper or the managed GitHub integration.