...
ملاحظة: تأكد أن RakshService معرف في common.py أو في ملف أساسي مستورد في common.py
"""

from .common import *  # هذا السطر يجب أن يوفر RakshService
...
# استيراد telegram (بعد إصلاح ParseMode)
...
class ForcedRefAIService(RakshService):
    ...
    def __init__(self):
        """تهيئة الخدمة"""
        super().__init__()  # استدعاء تهيئة الكلاس الأب
